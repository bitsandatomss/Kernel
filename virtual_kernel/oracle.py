...
from kernel.policy.core import HeuristicLatencyPolicy
...
class TruthOracle:
    ...
    - kernel/ itself is untouched; only this harness's instance is
    ...
    def reset(self, kir: Optional[KernelIntermediateRepresentation] = None) -> None:
        import random
        from kernel.simulator.env import WorkloadProfile
